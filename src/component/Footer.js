  ...
  return (
    <div className="px-5 lg:px-32 xl:px-44 py-10 flex flex-col-reverse gap-10 lg:flex-row items-center justify-between bg-Very-Dark-Blue">
      ...
      <div className="flex flex-col-reverse lg:flex-col items-center lg:items-start gap-12">
        <div className="">
          <h1 className="text-white italic text-2xl font-bold">Space X</h1>
        </div>
      ...
      <div className="flex gap-24 lg:gap-44 text-sm text-Very-Pale-Red">
        ...
        <ul className="flex flex-col gap-2">
          ...
          <li className="hover:text-Bright-Red cursor-pointer">
            Privacy Policy
          </li>
        </ul>
      </div>
      ...
      <div className="flex flex-col gap-12 text-xs ">
        <div className="flex gap-2 items-center relative">
          ...
          />
          <button className="bg-yellow-500 shadow-md rounded-full text-white font-semibold w-16 md:w-24 lg:w-12 h-9 hover:bg-white hover:text-yellow-500">
            Go
          </button>
        </div>
